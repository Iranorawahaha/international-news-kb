...
| **数据源** | 11 大英文权威信源（路透/BBC/南华早报/卫报/CNN/纽时/WSJ/半岛/Politico/华邮/AP）+ **6 大美国官方信源**（白宫/国务院/USTR/财政部/商务部/国防部） |
| **采集方式** | WorkBuddy WebFetch + curl 直连（白宫/国务院/财政部 curl 直连；商务部/国防部/USTR 反爬走 WebFetch 通道） |
| **核心特性** | 双语标题 · 元首级标注 · 7 天滚动存档 · 日期 Tab + **六大栏目 Tab** · 栏目内优先级排序 |
| **栏目分类** | 🇨🇳 中国（高层涉外）/ 🇺🇸 美国（涉华/经贸制裁/科技战/特朗普言行）/ 🇪🇺 欧洲（涉华法案/选举）/ 🌍 地区热点（中东/俄乌等）/ 🏛️ 国际会议（G7/APEC/QUAD/G20）/ 📌 其他 |
| **优先级排序** | ① 元首+涉华 ② 仅涉华 ③ 仅元首 ④ 其余；跨区域按核心决策主体归属 |
